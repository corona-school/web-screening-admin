          ...
          <Descriptions bordered size="small" column={1}>
            <Descriptions.Item label="Verifiziert">
              <Checkbox
                ...
                onChange={(event) =>
                  changeScreening('verified', event.target.checked)
                }
              />
            </Descriptions.Item>
            <Descriptions.Item label="Kommentar">
              <TextArea
                ...
                onChange={(event) =>
                  changeScreening('comment', event.target.value)
                }
              />
            </Descriptions.Item>
            <Descriptions.Item label="Kennt uns durch">
              ...
              >
                ...
                <Option value="Fernsehbeitrag">
                  {' '}
                  Über einen Fernsehbeitrag
                </Option>
...
export const BasicEditableInformationEditor = ({
  studentInfo,
  changeStudentInfo,
}: StudentInfoProps) => {
  return (
    ...
    <Descriptions column={1} bordered className={classes.descriptionsStyle}>
      <Descriptions.Item label="Tutor*in">
        <Checkbox
          ...
          onChange={(event) =>
            changeStudentInfo('isTutor', event.target.checked)
          }
        />
      </Descriptions.Item>
      <Descriptions.Item label="Kursleiter*in/ Praktikant*in">
        <Checkbox
          ...
          onChange={(event) =>
            changeStudentInfo('isInstructor', event.target.checked)
          }
        />
      </Descriptions.Item>
      <Descriptions.Item label="JuFo">
        <Checkbox
          ...
          onChange={(event) =>
            changeStudentInfo('isProjectCoach', event.target.checked)
          }
        />
      </Descriptions.Item>
    </Descriptions>
...
export const TutorInformationEditor = ({
  studentInfo,
  changeStudentInfo,
  setScreening,
}: StudentScreeningProps) => {
  return (
    <Descriptions
      column={1}
      bordered
    ...
    >
      ...
      <Descriptions.Item label="Screening">
        <ScreeningEditor
          screening={studentInfo?.screenings.tutor}
...
export const InstructorInformationEditor = ({
  studentInfo,
  changeStudentInfo,
  setScreening,
}: StudentScreeningProps) => {
  ...
  return (
    ...
    >
      <Descriptions.Item label="Praktikum">
        <Checkbox
          checked={!!studentInfo?.official}
          onChange={(event) => {
            if (event.target.checked) {
              changeStudentInfo('official', {
                module: TeacherModule.INTERNSHIP,
                hours: 1,
              });
            } else {
              confirm({
                ...
                content:
                  'Eine Änderung des Status führt zum Verlust von Modul-Typ und Modulstunden',
                okText: 'Ja',
                cancelText: 'Nein',
                onOk() {
        ...
        <>
          <Descriptions.Item label="Bundesland">
            <Select
              ...
              style={{ width: '300px' }}
              options={Object.entries(StateLong).map((e) => ({
                label: e[1],
                value: e[0],
              }))}
            />
          ...
          <Descriptions.Item label="Universität">
            <Input
              ...
              onChange={(event) =>
                changeStudentInfo('university', event.target.value)
              }
            />
          </Descriptions.Item>
          <Descriptions.Item label="Modul-Typ">
            <Select
              ...
              options={Object.entries(TeacherModulePretty).map((e) => ({
                label: e[1],
                value: e[0],
              }))}
              style={{ width: '120px' }}
      ...
      <Descriptions.Item label="Screening">
        <ScreeningEditor
          screening={studentInfo?.screenings.instructor}
          setScreening={setScreening}
        />
      </Descriptions.Item>
    </Descriptions>
...
export const JuFoInformationEditor = ({
  studentInfo,
  changeStudentInfo,
  setScreening,
}: StudentScreeningProps) => {
    ...
    >
      <Descriptions.Item label="Projekte">
        <ProjectList
          ...
          setProjects={(projects) =>
            changeStudentInfo('projectFields', projects)
          }
        />
      </Descriptions.Item>
      <Descriptions.Item label="JuFo-Alumni">
        <Select
          ...
          style={{ width: '120px' }}
        >
          <Option value={TutorJufoParticipationIndication.IDK}>
            Weiß nicht
          </Option>
      ...
      <Descriptions.Item label="Nachweis für frühere JuFo-Teilnahme">
        <Checkbox
          ...
          onChange={(event) =>
            changeStudentInfo('hasJufoCertificate', event.target.checked)
          }
        />
      </Descriptions.Item>
      <Descriptions.Item label="Frühere Teilnahme bestätigt">
        <Checkbox
          ...
          onChange={(event) =>
            changeStudentInfo(
              'jufoPastParticipationConfirmed',
      ...
      <Descriptions.Item label="Informationen zu früherer Teilnahme">
        <TextArea
          ...
          onChange={(event) =>
            changeStudentInfo('jufoPastParticipationInfo', event.target.value)
          }
        />
      </Descriptions.Item>
      <Descriptions.Item label="Eingeschriebene*r Student*in">
        <Checkbox
          ...
          onChange={(event) =>
            changeStudentInfo('isUniversityStudent', event.target.checked)
          }
        />
      </Descriptions.Item>
      <Descriptions.Item label="Screening">
