...
export const BasicStaticInformation = ({studentInfo}: {studentInfo: IStudentInfo | null}) => {
    return (
...
export const TypeDisplay = ({studentInfo}: {studentInfo: IStudentInfo | null}) => {
    return (
