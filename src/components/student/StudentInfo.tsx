...
import {
  BasicEditableInformationDisplay,
  BasicStaticInformation,
  InstructorInformationDisplay,
  JuFoInformationDisplay,
...
const StudentInfo = (props: RouteComponentProps<MatchParams>) => {
  ...
  const { studentInfo, setStudentInfo, loading, save, reload } = useStudent(
    email || ''
  );
      ...
      <>
        ...
        {!openEdit && (
          <>
            ...
            {studentInfo?.isTutor && (
              <TutorInformationDisplay studentInfo={studentInfo} />
            )}
            {studentInfo?.isInstructor && (
              <InstructorInformationDisplay studentInfo={studentInfo} />
            )}
            {studentInfo?.isProjectCoach && (
              <JuFoInformationDisplay studentInfo={studentInfo} />
            )}
          </>
        )}
      </>
