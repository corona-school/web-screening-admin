...
export function VerifyStudent({ student, decision }: { student: IStudent, decision: boolean}) {
...
export function CompleteJob(
    ...
    return ({
        ...
        data: {
            ...job.data,
            screenings: {
                tutor: screeningTypes.includes('tutor') ? screening : job.data.screenings.tutor,
                instructor: screeningTypes.includes('instructor') ? screening : job.data.screenings.instructor,
                projectCoach: screeningTypes.includes('projectCoach') ? screening : job.data.screenings.projectCoach,
            },
        },
    })
}
